...
urlpatterns = [
    ...
    # jat:repository_delete
    # path('repsoitory/<int:repository_pk>/introduction/add/', views.IntroductionCreateView.as_view(), name='introduction_add'),
    path('repsoitory/<int:repository_pk>/introduction/add/', views.add_introduction, name='introduction_add'),
    path('repsoitory/<int:repository_pk>/introduction/<int:pk>/modify/', views.IntroductionUpdateView.as_view(),
         name='introduction_modify'),
    path('repsoitory/<int:repository_pk>/introduction/<int:pk>/delete/', views.IntroductionDeleteView.as_view(),
         name='introduction_delete'),
    path('repsoitory/<int:repository_pk>/introduction/<int:introduction_pk>/comment/add/',
         views.CommentCreateView.as_view(), name='comment_add'),
    path('repsoitory/<int:repository_pk>/introduction/<int:introduction_pk>/comment/<int:pk>/modify/',
         views.CommentUpdateView.as_view(), name='comment_modify'),
    path('repsoitory/<int:repository_pk>/introduction/<int:introduction_pk>/comment/<int:pk>/delete/',
